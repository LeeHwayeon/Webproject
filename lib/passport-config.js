...
module.exports = function(passport) {
  ...
  passport.use(new FacebookStrategy({
    ...
    //조교가 못봄
    clientID : '1560082867371464',       
    clientSecret : '8b2010ecd808174f83bd8aecccc4b9de',
...
module.exports = function(passport){
  ...
  passport.use(new KakaoStrategy({
    ...
    clientSecret: 'tRWdRUsVSisrBS0BWd24pB6157lKonZ5', // clientSecret을 사용하지 않는다면 넘기지 말거나 빈 스트링을 넘길 것
