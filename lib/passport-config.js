...
module.exports = function(passport) {
  ...
  const callbackURL =(process.env.NODE_ENV == 'production')?
    'https://serene-anchorage-88997.herokuapp.com/auth/facebook/callback':
    'http://localhost:3000/auth/facebook/callback';
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    //내것으로 수정함!
    // callbackURL 나중에 헤로쿠? 거기다 올릴때 바뀌는 url로 다시 설정해줘야함 localhost로 하면
    //조교가 못봄
    clientID : process.env.FBID || '1560082867371464',       
    clientSecret : process.env.FB_SECRET || 'ba716d56943bd64773c78cfe09e29dc5',
  ...
  passport.use(new KakaoStrategy({
    clientID : ' 21b460e0b5ebfb0d72ce7b7014276498',       
    clientSecret : 'zHWTgs7PFsupzCpd133rgs1Zgw1iIoyn',
